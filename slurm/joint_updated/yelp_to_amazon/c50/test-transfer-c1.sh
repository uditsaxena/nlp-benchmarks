#!/bin/bash
#
#SBATCH --job-name=mixed-05-us-vdcnn
#SBATCH --partition=m40-short
#SBATCH --output=50-test-transfer-%A.out
#SBATCH --error=50-test-transfer-%A.err
#SBATCH --gres=gpu:1

# Log what we're running and where.
echo $SLURM_JOBID - `hostname` >> ~/slurm-jobs.txt

test_dataset="amazon_polarity"
dataset="yelp_polarity"
combined_datasets="yelp_polarity---amazon_polarity"
depth=29
model_folder="models/VDCNN/VDCNN_${combined_datasets}_depth@${depth}/50"
epoch_size=5000
batch_size=128
