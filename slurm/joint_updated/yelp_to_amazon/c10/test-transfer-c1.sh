#!/bin/bash
#
#SBATCH --job-name=mixed-01-us-vdcnn
#SBATCH --partition=m40-short
#SBATCH --output=10-test-transfer-%A.out
#SBATCH --error=10-test-transfer-%A.err
#SBATCH --gres=gpu:1
...
depth=29
model_folder="models/VDCNN/VDCNN_${combined_datasets}_depth@${depth}/10"
epoch_size=5000
batch_size=128
